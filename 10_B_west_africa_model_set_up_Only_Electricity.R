...
save(dhE,met_dhmodsELEC,tocDHmods,file='10_west_africa_trained_models_w_seasonal_mean_ELEC.Rdata')  #
...
dhtE<-dht
save(dhtE,tocTIMEmods,met_TIMEmodsELEC,file='10_west_africa_trained_models_TIME_w_seasonal_mean_ELEC.Rdata')
